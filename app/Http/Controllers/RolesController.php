        ...
        return Datatables::of($roles)
            ->addColumn('namelink', function ($roles) {
                ...
                if ($roles->name == Role::ADMIN_ROLE) {
                    return '<a href="'.route('roles.show', $roles->external_id).'">'.$roles->display_name.'</a>' . '<br>' . __('Extra: Manager is able to update and create departments, integrations, and settings');
                }
